...
<script>
    <?php 
        $url = getcwd();
        $file = '/Views/Templates/files/resultAverage.json';
    ?>
    
    $.getJSON( "<?php echo URL.'index.php?url=view_average_product/1'; ?>", data )
...
//    /**Add*/
//    $.getJSON( "<?php echo URL.'index.php?url=view_average_product/1'; ?>", { "parametro1" : "valor1", "parametro2" : "valor2" } )
//        .done(function( data, textStatus, jqXHR ) {
//            if ( console && console.log ) {
//                console.log( "La solicitud se ha completado correctamente." );
//            }
